...
export default function CTASection(props: CTASectionProps) {
  return (
    <section className="section-shell lg:pt-24">
      <div className="rounded-3xl bg-gradient-to-r from-brandBlue to-brandGreen p-8 text-white md:p-12 lg:px-14 lg:py-14 xl:px-16 xl:py-16">
        <div className="lg:grid lg:min-h-[14rem] lg:grid-cols-[minmax(0,1fr)_auto] lg:items-center lg:gap-12">
